   ...
   WIN_COORD x[],y[];
{
   ...
   DEBUG("TANGOpath_create(%d, %lf..., %lf...)\n", num, *x, *y);
   ...
   int num;
{
   ...
   DEBUG("TANGOpath_add_head(0x%p, %d)\n", path, num);
   ...
   int num;
{
   ...
   DEBUG("TANGOpath_add_tail(0x%p, %d)\n", path, num);
   ...
   int num;
{
   ...
   DEBUG("TANGOpath_delete_head(0x%p, %d)\n", path, num);
   ...
   int num;
{
   ...
   DEBUG("TANGOpath_delete_tail(0x%p, %d)\n", path, num);
   ...
   double xscale,yscale;
{
   ...
   DEBUG("TANGOpath_scale(0x%p, %lf, %lf)\n", path, xscale, yscale);
   ...
   double x,y;
{
   ...
   DEBUG("TANGOpath_extend(0x%p, %lf, %lf)\n", path, x, y);
   ...
   double factor;
{
   ...
   DEBUG("TANGOpath_interpolate(0x%p, %lf)\n", path, factor);
   ...
   TANGO_PATH path;
{
   ...
   DEBUG("TANGOpath_example(0x%p, 0x%p, 0x%p)\n", fromloc, toloc, path);
   ...
   TANGO_PATH_TYPE type;
{
   ...
   DEBUG("TANGOpath_motion(0x%p, 0x%p, %d)\n", fromloc, toloc, type);
   ...
   WIN_COORD distance;
{
   ...
   DEBUG("TANGOpath_distance(0x%p, 0x%p, %lf)\n", fromloc, toloc, distance);
   ...
   double num;
{
   ...
   DEBUG("TANGOpath_iterate(0x%p, %lf)\n", path, num);
   ...
   TANGO_PATH p0,p1,p2,p3,p4,p5,p6,p7,p8,p9;
{
   ...
   DEBUG("TANGOpath_concatenate(%d, 0x%p, 0x%p, 0x%p, 0x%p, 0x%p, 0x%p...)\n",
	 num, p0, p1, p2, p3, p4, p5);
   ...
   TANGO_PATH p0,p1,p2,p3,p4,p5,p6,p7,p8,p9;
{
   ...
   DEBUG("TANGOpath_compose(%d, 0x%p, 0x%p, 0x%p, 0x%p, 0x%p, 0x%p...)\n",
	 num, p0, p1, p2, p3, p4, p5);
   ...
   TANGO_PATH p1,p2,p3,p4,p5,p6,p7,p8,p9,p10;
{
   ...
   DEBUG("TANGOpath_free(%d, 0x%p, 0x%p, 0x%p, 0x%p, 0x%p, 0x%p...)\n",
