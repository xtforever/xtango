   ...
   TANGO_TRANS t1,t2,t3,t4,t5,t6,t7,t8,t9,t10;
{
   ...
   DEBUG("TANGOtrans_concatenate(%d, 0x%p, 0x%p, 0x%p, 0x%p, 0x%p, 0x%p...)\n",
   ...
   TANGO_TRANS t1,t2,t3,t4,t5,t6,t7,t8,t9,t10;
{
   ...
   DEBUG("TANGOtrans_compose(%d, 0x%p, 0x%p, 0x%p, 0x%p, 0x%p, 0x%p ...)\n",
	 num, t1, t2, t3, t4, t5, t6);
   ...
   TANGO_TRANS t1,t2,t3,t4,t5,t6,t7,t8,t9,t10;
{
   ...
   DEBUG("TANGOtrans_free(%d, 0x%p, 0x%p, 0x%p, 0x%p, 0x%p, 0x%p...)\n",
	 num, t1, t2, t3, t4, t5, t6);
